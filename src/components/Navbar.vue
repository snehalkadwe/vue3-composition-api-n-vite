<template>
  <div class="w-full flex items-center content-center h-12 pl-4 bg-indigo-500 text-white shadow pt-0">
      <div>
          <router-link to="/" class="nav-link justify-self-center">Home</router-link>
